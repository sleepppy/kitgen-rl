...
extern "C" {
  ...
  __declspec(dllexport) bool __stdcall simulation_step(kite* k, const double step, const vect wind){
  ...
  __declspec(dllexport) double __stdcall getreward(kite* k, const vect wind, const double C_l, const double C_d, const double psi){
